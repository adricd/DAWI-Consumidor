...
public class CatalogoEventListener {
		...
		@KafkaListener( topics = "${topic.customer.name:topic-catalogo-Casas}",
	...
	SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
		...
		if (event.getClass().isAssignableFrom(CatalogoCreateEvent.class)) {
			...
			Catalogo objPais = objEvent.getData();
			
			int idCatalogo = objPais.getIdCatalogo();
			String descripcion = objPais.getDescripcion();
			...
			System.out.println(">>8  Descripcion: " + descripcion);
		}
	}
}